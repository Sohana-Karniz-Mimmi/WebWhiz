    ...
    <div className="flex flex-col md:flex-row gap-8 md:mt-[48px] mt-[30px]">
              ...
              <div className="flex-1 h-[10px] rounded-[16px] overflow-hidden">
                <div
                  ...
                  style={{
                    ...
                    background:
                      "linear-gradient(99deg, #5F90F0 5.67%, #185AD9 98.08%)",
                  }}
                />
                <div
                  className="h-full rounded-[16px] -mt-[10px]"
                  style={{
                    width: "100%",
                    background:
                      "linear-gradient(99deg, rgba(95, 144, 240, 0.10) 5.67%, rgba(24, 90, 217, 0.10) 98.08%)",
                  }}
                />
              </div>
      ...
      <div className="flex-1 max-w-[554px] h-[312px] rounded-[12px] bg-[#F4FBF7] relative flex items-center">
        ...
        <div className="absolute -bottom-[72px] left-0 -right-[130px] flex justify-center">
          <div className="w-full max-w-[531px] h-[124px] p-[32px] rounded-[12px] bg-gradient-to-r from-[#5F90F0] to-[#185AD9] flex items-center justify-between">
...
//         <div className="relative w-full h-full min-h-[298px] rounded-[12px] overflow-hidden">
//           <Image
//             src="/images/about.png"
//             alt="Skills illustration"
//             fill
