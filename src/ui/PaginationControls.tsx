...
const PaginationControls: React.FC<PaginationControlsProps> = ({
  ...
  onPrev,
  onNext,
  prevButtonClass = "flex w-[32px] h-[32px] justify-center items-center rounded-[80px] border border-[#5F90F0]",
  nextButtonClass = "flex w-[32px] h-[32px] justify-center items-center rounded-[80px] bg-gradient-to-r from-[#5F90F0] to-[#185AD9]",
